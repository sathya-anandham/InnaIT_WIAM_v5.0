...
import io.innait.wiam.authorchestrator.entity.AuthTransactionId;
...
public interface AuthTransactionRepository extends JpaRepository<AuthTransaction, AuthTransactionId> {
